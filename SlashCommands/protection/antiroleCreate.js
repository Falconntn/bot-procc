...
const antiroleModel = require("../../protection-models/antiroleCreateModel");
const trustModel = require("../../protection-models/trustModels");

module.exports = {
  name: "antirole-create",
  category: "protection",
  description: "Toggle the antirole-create feature on/off",
  id: "1109436746950783088",
  options: [
    {
      name: "toggle",
  ...
  run: async (client, interaction, args) => {
    ...
    const embed = new MessageEmbed()
      .setTitle(`antirole-create feature for ${interaction.guild.name}`)
      .setDescription(
        `The antirole-create feature for ${
